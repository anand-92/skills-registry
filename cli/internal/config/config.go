...
var ErrMissing = errors.New("no registry configured (set SKILLS_REGISTRY=owner/repo or run `skills-mcp init`)")
...
func Save(cfg Config) (string, error) {
	...
	body := "# Auto-generated by `skills-mcp init`. Edit `repo` to point at a different registry.\n" +
		"[registry]\n" +
		fmt.Sprintf("repo = %q\n", cfg.Repo) +
